                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>DUPLICANDO COTIZACIÓN MARÍTIMO FCL
                                    <a href="fcl.php" class="btn btn-danger btn-sm float-end">Regresar</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $query = "SELECT * FROM fcl WHERE id='$registro_id' ";
                                    $query_run = mysqli_query($con, $query);

                                    if (mysqli_num_rows($query_run) > 0) {
                                        $registro = mysqli_fetch_array($query_run);
                                        $titulo = $registro['tipoFcl'];
                                ?>
                                                ...
                                                <select class="form-select bg-warning" name="tipoFcl" required>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($titulo = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $selected = ($registro['tipoFcl'] == $nombre) ? "selected" : ""; // Verifica si es el seleccionado
                                            ...
                                            <div class="col-12 text-center p-2">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped" id="miTablaCotizacion" style="margin-bottom: 0px;">
                                                        ...
                                                        <?php
                                                        // Obtener los registros de descripcionmercanciasfcl relacionados con el ID de fcl
                                                        $query_desc = "SELECT * FROM descripcionmercanciasfcl WHERE idFcl='$registro_id'";
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <table class="table table-striped origen-table text-start" id="origenTable">
                                                            ...
                                                            <?php
                                                            $query_origen = "SELECT * FROM gastosorigenfcl WHERE idFcl='$registro_id'";
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <table class="table table-striped destino-table text-start" id="destinoTable">
                                                            ...
                                                            <?php
                                                            $query_destino = "SELECT * FROM gastosdestinofcl WHERE idFcl='$registro_id'";
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped table-bordered" id="incrementableTable" style="margin-bottom: 0px;">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $query_incrementable = "SELECT * FROM incrementablesfcl WHERE idFcl='$registro_id'";
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped table-bordered" id="tablaGasto" style="margin-bottom: 0px;">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $query_gasto = "SELECT * FROM gastosfcl WHERE idFcl='$registro_id'";
                                                            ...
                                                            if (mysqli_num_rows($query_run_gasto) > 0) {
                                                                while ($gasto = mysqli_fetch_assoc($query_run_gasto)) {
                                                                    ...
                                                                    $query_incrementable_id = "SELECT id FROM incrementablesfcl WHERE incrementable = '$conceptoGasto' AND idFcl='$registro_id' LIMIT 1";
