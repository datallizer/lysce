...
<head>
    ...
    <title>Marítimo LCL | LYSCE</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 style="color:#fff" class="m-1">
                                    <a class="btn btn-sm btn-primary float-end" href="form-lcl.php">Nueva cotización</a>
                                    LCL - COTIZACIONES
                                </h4>
                            </div>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 105px;text-align:center;">
                                                        <a href="<?= $linkHabilitado ? 'generate_lcl.php?id=' . $registro['id'] : '#' ?>"
                                                        ...
                                                        <a href="editar-lcl.php?id=<?= $registro['id']; ?>" class="btn btn-warning btn-sm m-1"><i class="bi bi-pencil-square"></i></a>

                                                        <form action="codelcl.php" method="POST" class="d-inline">
                                                        ...
                                                        <a href="duplicar-lcl.php?id=<?= $registro['id']; ?>" class="btn btn-secondary btn-sm m-1"><i class="bi bi-copy"></i></a>
