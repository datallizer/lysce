...
";
    ...
    $query_mercancias = "SELECT * FROM descripcionmercanciasfcl WHERE idFcl = $id";
    ...
    $query_fcl = "SELECT valorEquivalencia FROM fcl WHERE id = $id";
    $resultado_fcl = mysqli_query($con, $query_fcl);
    $equiv = mysqli_fetch_assoc($resultado_fcl);


    $query_origen = "SELECT * FROM gastosorigenfcl WHERE idFcl = $id";
    ...
    $query_destino = "SELECT * FROM gastosdestinofcl WHERE idFcl = $id";
    ...
    $query_incrementables = "SELECT incrementable, incrementableUSD, incrementableMx FROM incrementablesfcl WHERE idFcl = $id";
    ...
    $query_gasto = "SELECT * FROM gastosfcl WHERE idFcl = $id";
...
<body>
    ...
    <br>
    <p class="text-center bg-warning" style="border: 1px solid #666666;margin: 5px 0px;padding:5px;"><b>' . $registro['tipoFcl'] . '</b></p>
    <table class="table">
        <tr>
