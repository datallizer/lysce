...
<head>
    ...
    <title>Carta de instrucciones | LYSCE</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="carta-instrucciones.php" class="btn btn-danger btn-sm float-end">Regresar</a>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="codeftl.php" method="POST" class="row justify-content-evenly">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input class="form-control" name="tipoFtl">
                                        <p>Folio</p>
                                        ...
                                        <div class="card">
                                            ...
                                            <table class="table table-striped" style="margin-bottom: 0px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>largo x ancho x alto mts</p>
                                                        <p>largo x ancho x alto plg</p>
                                                    </td>
                                                    <td>
                                                        <p> Lbs</p>
                                                        <p> Kgs</p>
                                    ...
                                    <div class="col-6">
                                        <p style="display: inline-block;margin-bottom: 5px;">
                                            <b>Fecha de carga:</b>
                                            <input name="carga" class="form-control" style="width: 267px; display: inline-block;" type="date">
                                        </p>
                                        <p style="display: inline-block;margin-bottom: 5px;">
                                            <b>Horario de carga:</b>
                                            <input name="horacarga" class="form-control" style="width: 140px; display: inline-block;" type="time"> a
                                            <input name="limitecarga" class="form-control" style="width: 140px; display: inline-block;" type="time">
                                        </p>
                                        <p style="display: inline-block;margin-bottom: 5px;">
                                            <b>Tiempo de recorrido:</b>
                                            <input name="recorrido" class="form-control" style="width: 267px; display: inline-block;" type="text">
                                        </p>
                                    </div>
                                    <div class="col-6">
                                        <p style="display: inline-block;margin-bottom: 5px;">
                                            <b>Fecha de arribo:</b>
                                            <input name="arribo" class="form-control" style="width: 267px; display: inline-block;" type="date">
                                        </p>
                                        <p style="display: inline-block;margin-bottom: 5px;">
                                            <b>Horario de descarga:</b>
                                            <input name="horadescarga" class="form-control" style="width: 140px; display: inline-block;" type="time"> a <input name="limitedescarga" class="form-control" style="width: 140px; display: inline-block;" type="time">
                                        </p>
                                    </div>

                                    <div class="col-12 mt-5">
                                        <p><b>Observaciones:</b></p>
                                        <textarea class="form-control" style="min-height: 150px;" name="observaciones"></textarea>
