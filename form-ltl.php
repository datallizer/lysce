            ...
            <div class="container-fluid p-5">
                <form action="codeltl.php" method="POST" class="row justify-content-evenly">
                    ...
                    <div class="col-12 text-center bg-warning p-1" style="border: 1px solid #666666;border-bottom:0px;">
                        <select class="form-select bg-warning" name="tipoLtl" id="tipoLtlSelect" required onchange="agregarTipoServicio()">
...
-Costo del seguro .0035% sobre valor mercancías / mínimo $ 120.00 USD
    ...
    <script>
        ...
        function agregarTipoServicio() {
            var tipoSeleccionado = document.getElementById("tipoLtlSelect").value;
