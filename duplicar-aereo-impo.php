...
<head>
    ...
    <title>Duplicando importación aérea | LYSCE</title>
    ...
    <div id="layoutSidenav">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>DUPLICANDO COTIZACIÓN AÉREO IMPO
                                    <a href="aereo-importacion.php" class="btn btn-danger btn-sm float-end">Regresar</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $query = "SELECT * FROM aereo WHERE id='$registro_id' ";
                                    $query_run = mysqli_query($con, $query);

                                    if (mysqli_num_rows($query_run) > 0) {
                                        $registro = mysqli_fetch_array($query_run);
                                        $titulo = $registro['tipoAereoImpo'];
                                ?>
                                                ...
                                                <select class="form-select bg-warning" name="tipoAereoImpo" required>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($titulo = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $selected = ($registro['tipoAereoImpo'] == $nombre) ? "selected" : ""; // Verifica si es el seleccionado
                                            ...
                                            <div class="col-12 text-center p-2">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped" id="miTablaCotizacion" style="margin-bottom: 0px;">
                                                        ...
                                                        <?php
                                                        // Obtener los registros de descripcionmercanciasaereoimpo relacionados con el ID de Aereo
                                                        $query_desc = "SELECT * FROM descripcionmercanciasaereoimpo WHERE idAereo='$registro_id'";
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <table class="table table-striped origen-table text-start" id="origenTable">
                                                            ...
                                                            <?php
                                                            $query_origen = "SELECT * FROM gastosorigenaereoimpo WHERE idAereo='$registro_id'";
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        <td style="min-width: 140px;">
                                                                            <input style="min-width: 100%;" type="text" name="gastosOrigen[]" class="form-control" value="<?= $origen['gastosOrigen']; ?>" <?= $readonlyAttr ?>>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="minimoOrigen[]" class="minOrigen form-control" value="<?= $origen['minimoOrigen']; ?>" <?= $disabledAttr ?> oninput="actualizarTotalesOrigen();">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" name="amountOrigen[]" class="amOrigen form-control" value="<?= $origen['amountOrigen']; ?>">
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <div class="col-6">
                                                        <table class="table table-striped destino-table text-start" id="destinoTable">
                                                            <tr>
                                                                ...
                                                                <th colspan="3"><input type="text" name="lugarDestino" style="width: 100% !important;"></th>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td>USD</td>
                                                            ...
                                                            <?php
                                                            $query_destino = "SELECT * FROM gastosdestinoaereoimpo WHERE idAereo='$registro_id'";
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped table-bordered" id="incrementableTable" style="margin-bottom: 0px;">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $query_incrementable = "SELECT * FROM incrementablesaereoimpo WHERE idAereo='$registro_id'";
                                            ...
                                            <div class="col-12 mt-5">
                                                <div class="card">
                                                    ...
                                                    <table class="table table-striped table-bordered" id="tablaGasto" style="margin-bottom: 0px;">
                                                        <tbody>
                                                            <?php
                                                            $query_gasto = "SELECT * FROM gastosaereoimpo WHERE idAereo='$registro_id'";
                                                            ...
                                                            if (mysqli_num_rows($query_run_gasto) > 0) {
                                                                while ($gasto = mysqli_fetch_assoc($query_run_gasto)) {
                                                                    ...
                                                                    $query_incrementable_id = "SELECT id FROM incrementablesaereoimpo WHERE incrementable = '$conceptoGasto' AND idAereo='$registro_id' LIMIT 1";
        ...
        <script>
            ...
            function actualizarTotalesOrigen() {
                console.log('Se llamo actualizarTotalesOrigen');
