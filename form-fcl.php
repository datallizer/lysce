    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_content">
            <div class="container-fluid p-5">
                <form action="codefcl.php" method="POST" class="row justify-content-evenly">
                    ...
                    <div class="col-12 text-center bg-warning p-1" style="border: 1px solid #666666;border-bottom:0px;">
                        <select class="form-select bg-warning" name="tipoFcl" required>
                            <option value="" disabled selected>Selecciona una opción</option>
                            <?php
                            $query = "SELECT * FROM tiposervicio WHERE tipoServicio = 'fcl'";
                            $result = mysqli_query($con, $query);
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <table class="table table-striped origen-table text-start" id="origenTable">
                                    ...
                                    <tr>
                                        <td style="min-width: 140px;"><input style="min-width: 100%;" class="form-control" type="text" name="gastosOrigen[]" value="EXW Charges origin"></td>
                                        <td><input type="text" name="euros[]" class="euros form-control" oninput="actualizarTotalesOrigen();"></td>
                                        <td><input type="text" name="equivalenciaOrigen[]" class="equivalencia form-control" readonly></td>
                                        <td><input type="text" name="usdOrigen[]" class="usOrigen form-control" readonly></td>
                                        <td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarFilaOrigen(this)"><i class="bi bi-trash3"></i></button></td>
                                    ...
                                    <tr>
                                        <td style="min-width: 140px;"><input style="min-width: 100%;" class="form-control" type="text" name="gastosOrigen[]" value="Handling"></td>
                                        <td><input type="text" name="euros[]" class="euros form-control" oninput="actualizarTotalesOrigen();"></td>
                                        <td><input type="text" name="equivalenciaOrigen[]" class="equivalencia form-control" readonly></td>
                                        <td><input type="text" name="usdOrigen[]" class="usOrigen form-control" readonly></td>
                                        <td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarFilaOrigen(this)"><i class="bi bi-trash3"></i></button></td>
                            ...
                            <div class="col-6">
                                ...
                                <table class="table table-striped destino-table text-start" id="destinoTable">
                                    ...
                                    <tr>
                                        <td><input type="text" style="min-width: 100%;" name="gastoDestino[]" class="form-control" value="TERMINAL FEES X 1 containers"></td>
                    ...
                    <div class="col-12 p-0">
                        <table class="mt-3 w-100" style="border: 1px solid #000000;">
                            ...
                            <tr>
                                <td>
                                    <textarea value="" class="form-control" name="observaciones" style="min-height: 200px;" id="observaciones">-Para fletes MARÍTIMOS se requiere pago previo al arribo de las mercancias al puerto destino para su desconsolidacion y despacho
-En caso de requerir seguro de transito de mercancais tiene un costo de .0040 % sobre el valor de Mercancias
-Existe minimo de valor de deducible de $ 120 dls
-La mercancía viaja por cuenta y riesgo del cliente
-Se recomienda servicio de seguro de transito de mercancias
-Precio valido por 15 días, sujeto a cambio a base de disponibilidad
-Solicitar equipo con 24 Hrs de anticipacion
</textarea>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="modal-footer mt-5">
                        <a href="fcl.php" class="btn btn-secondary m-1">Cancelar</a>
    ...
    <script>
        ...
        <td>
            <select class="form-select conceptoIncrementable" name="incrementable[]" onchange="actualizarConceptoGasto(this)">
                <option value="" disabled selected>Selecciona una opción</option>
                <?php
                $query = "SELECT * FROM tipoincrementable WHERE tipo = 'fcl'";
                $result = mysqli_query($con, $query);
    ...
    `;
        ...
        function agregarFilaDespuesDeAMS() {
            ...
            nuevaFila.innerHTML = `
                <tr>
                    <td style="min-width: 140px;"><input style="min-width: 100%;" class="form-control" type="text" name="gastosOrigen[]"></td>
                    <td><input type="text" name="euros[]" class="euros form-control" oninput="actualizarTotalesOrigen();"></td>
                    <td><input type="text" name="equivalenciaOrigen[]" class="equivalencia form-control" readonly></td>
                    <td><input type="text" name="usdOrigen[]" class="usOrigen form-control" readonly></td>
                    <td><button type="button" class="btn btn-danger btn-sm" onclick="eliminarFilaOrigen(this)"><i class="bi bi-trash3"></i></button></td>
