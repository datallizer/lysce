                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 style="color:#fff" class="m-1">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm float-end m-1" data-bs-toggle="modal" data-bs-target="#asociarModal">
                                        Asociar
                                    </button>
                                    CLIENTES
                                </h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $proveedores_query = "SELECT p.cliente, pc.id as idasoc
                                                                                ...
                                                                                JOIN clientes p ON pc.idProveedor = p.id
